...
import AdminAlertsTable from "./admin-alerts-table"
...
export default async function AlertsListPage() {
  ...
  const alerts = await sql`
    SELECT id, ticker, company_name, price, sentiment, sent_at, content, subject, recipient_count
    FROM alerts
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <AdminAlertsTable alerts={alerts as any[]} />
      </div>
    </div>
  )
}
