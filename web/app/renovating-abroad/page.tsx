...
const PAGE_URL = "https://www.monthlyalerts.com/renovating-abroad";
...
export async function generateMetadata(): Promise<Metadata> {
  const c = COPY[await getVisitorLang()];
  return {
    title: c.metaTitle,
    ...
    openGraph: { title: c.metaTitle, description: c.metaDesc, url: PAGE_URL },
  };
}

export default async function RenovatingAbroadPage() {
