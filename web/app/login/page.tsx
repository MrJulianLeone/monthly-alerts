      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          <div className="sheet p-8 sm:p-10">
            ...
            <h1 className="display text-4xl mb-3">{t(lang, "login_title")}</h1>
            <p className="text-sm text-ink-soft leading-relaxed mb-8">{t(lang, "login_sub")}</p>
            ...
            <LoginForm lang={lang} redirect={params.next ?? null} />
          </div>
